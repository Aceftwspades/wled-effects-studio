...
def build_menus(app):
    with dpg.menu_bar(tag="menubar"):
        with dpg.menu(label="File"):
            ...
            _mi(app, "Record 15 s video", "record_video", callback=lambda: app.start_rec(15.0, "mp4"))
            dpg.add_separator()
...
def build_toolbar(app):
    ...
    with dpg.group(horizontal=True, tag="toolbar"):
        ...
        _btn(app, "record", "Record 15 s as a GIF (a video: File > Record 15 s video)", lambda: app.start_rec(15.0), tag="rec_btn", action="record")
